...
- **TELEGRAPH_TOKEN** : Telegraph token by clicking here [clicking here](https://telegraph-token.sonywegas.repl.run/) or generated by running :
```
...
- **USER_SESSION_STRING** : Generate String session by [clicking here](https://string-session.sonywegas.repl.run/) **OR** you can generate by running :
```
